...
public class GridViewChatHuuco2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(GridViewChatHuuco2.this, GridViewChatHuuco.class));
            }
        });
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, url,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        Intent intent = new Intent(GridViewChatHuuco2.this, ChonPhanUng.class);
                        intent.putExtra("phanUngModel", phanUngModel);
                        GridViewChatHuuco2.this.startActivity(intent);
                    }
                },
                new Response.ErrorListener() {
                    @Override
